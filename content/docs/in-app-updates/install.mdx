...
Then rebuild from Xcode or your normal React Native command.

**Android:**

Rebuild from Android Studio or your normal React Native command.

### Expo

Use a development build because this package includes native code.

```bash
npx expo prebuild
```

Then build and run a development app with your normal Expo workflow.
