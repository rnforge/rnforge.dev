---
title: Quick Start
description: Copy the basic status, update-flow, and store-page examples.
---

Use these examples when you want the smallest possible calls. For screen-level wiring, see [App Integration](./app-integration).
