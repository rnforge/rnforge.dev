...
This guide explains how to use `@rnforge/react-native-in-app-updates` effectively. For the complete auto-generated reference, see the [API Reference](./reference).
